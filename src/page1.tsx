        ...
        <>
            <div className=" h-full bg-black">
                ...
                <div className="bg-gray-200 ml-2 mr-2">
                    ...
                    <div className="rounded-md shadow-md bg-white mx-3 my-3 text-cyan-700">
                        ...
                        <div className="">
                            ...
                            <div className="grid grid-cols-2 text-center">
                                <div className="border-b border-gray-400 ml-6">Frequency: Monthly</div>
                                <div className="border-b border-gray-400 mr-6">Autosave Amount: UGX 1,000</div>

                                <div className="flex flex-col items-center gap-1 border-r mt-2 border-gray-400 "> <LiaBoxOpenSolid className="w-4 h-4" /> <div>Deposit</div> </div>
